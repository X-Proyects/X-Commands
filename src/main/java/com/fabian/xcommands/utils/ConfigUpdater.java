...
public class ConfigUpdater {
    ...
    private static void updateHierarchicalFile(XCommands plugin, String resourcePath, File diskFile, YamlConfiguration diskConfig, YamlConfiguration resConfig) throws IOException {

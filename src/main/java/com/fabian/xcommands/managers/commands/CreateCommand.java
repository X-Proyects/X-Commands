...
public class CreateCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        DebugLogger.debug("Create command requested: " + commandName + " by " + sender.getName());
        ...
        if (plugin.getCommandManager().createCommand(commandName)) {
            DebugLogger.debug("Command created successfully: " + commandName);
            ...
            DebugLogger.debug("Command creation failed (already exists): " + commandName);
